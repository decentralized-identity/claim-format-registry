...
|`ac_vc`,`ac_vp`|"AnonCreds VC/VP"|Verifiable Credentials or Verifiable Presentations made using the CL-signature scheme. Specification of AnonCreds is currently underway at the Anon-Creds WG ([anoncreds-wg][]).|n/a|`CLSignature2019`|
